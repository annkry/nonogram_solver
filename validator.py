...
# -*- coding: UTF-8 -*-
'''
A simple validator. Examples of usage:

1. Running all tests for a given task:
python validator.py zad1 python main.py

2. Running on different tests:
python validator.py --testset large_tests.yaml zad1 python main.py

3. Printing example input/output:
python validator.py --show_example zad1

4. Printing information about the solution:
python validator.py --verbose zad1 python main.py

5. Forcing the use of STDIN/STDOUT for communication:
python validator.py --stdio zad1 python main.py

6. Setting a timeout multiplier for time limits:
python validator.py --timeout-multiplier 2.5 zad1 python main.py
'''
...
DEFAULT_TESTSET = yaml.safe_load(DEFAULT_TESTSET_YAML)
